...
public class SilvanElf extends Heroes {
    private boolean hasAttackUltimate;

    public SilvanElf(String nameOfHero, int range, int defence, int attackFromWiki, int attack, int health, int speed, int position, boolean hasAttackUltimate) {
        super(nameOfHero, range, defence, attackFromWiki, attack, health, speed, position, hasAttackUltimate);
        hasAttackUltimate = true;
    }
